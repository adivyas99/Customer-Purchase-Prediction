...
dataset = pd.read_csv('NSEMLAV2.csv')
X = dataset.iloc[:, [1,2, 3,4,5]].values
y = dataset.iloc[:, 8].values

# Splitting dataset into the Training and Test set in 4:1 ratio
...
# 2. Fitting Kernel SVM to the Training set--

classifier = SVC(kernel = 'rbf', random_state = 0)
# Classification will be on the "rbf" Kernel
