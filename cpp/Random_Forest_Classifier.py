...
# Splitting dataset into the Training and Test set in 3:1 ratio
...
# 2. Fitting Random Forest Classification to the Training set--

classifier = RandomForestClassifier(n_estimators = 10, criterion = 'entropy', random_state = 0)
# Classification will be on "entropy" criterion and 10 trees estimators
